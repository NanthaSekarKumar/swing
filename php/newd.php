...
$sql = "INSERT INTO newd (cname,street,city,state,zip,country,email,website,lat,lon,bakedgoods,cheese,arts_crafts,flowers,sea_foods,fruits,herbs,vegetables,honey,jams,maple,meats,nuts,plants,soap) VALUES ('$cname','$street','$city','$state','$postal','$country','$mail','$website','$latitude','$longitude','$bake','$chees','$arts','$flower','$sea','$fruit','$herb','$vegetable','$honey','$jams','$maple','$meats','$nuts','$plants','$soap')";
header('Location: newd.html');
